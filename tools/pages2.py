...
<section class="relight" data-points="[[13,64,24],[27,68,22],[36,52,20],[49,55,22],[52,76,24],[68,52,22],[75,70,22],[89,44,20]]">
  <div class="relight-stick">
    <div class="relight-stage">
      ...
      <div class="rl-copy">
        <div class="wrap">
          <p class="eyebrow">Parking lighting &middot; scroll to switch it on</p>
          <h2 class="disp">No dark gaps<br>between the pools</h2>
          <p>A lot is not lit because the fixtures work. It is lit when the pools overlap and there is nowhere left that feels unsafe walking to your car. Keep scrolling and watch the gaps close.</p>
        </div>
      </div>
    </div>
  </div>
