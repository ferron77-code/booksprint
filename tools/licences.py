#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Write the licence numbers into index.html.
...
proof strip, which stacks rather than running inline.
"""
import io, os, re, sys
...
from chrome import licence_line
...
def main():
    ...
    print("index.html: %d licence slot(s) written" % n)
