...
<section class="sec sec-tight">
  <div class="wrap">
    ...
    <dl class="rows rv">
      <div class="row"><dt>More photos</dt><dd>If you had more than five, or something too large for the form, email them to <a href="mailto:info@elighting.org" style="color:var(--brand)">info@elighting.org</a> and we will put them with your enquiry.</dd></div>
